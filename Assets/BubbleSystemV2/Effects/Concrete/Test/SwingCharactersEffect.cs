...
namespace BubbleSystem2
{
    ...
    {
        private static readonly SwingCharactersEffect instance = new SwingCharactersEffect();

        private SwingCharactersEffect()
        {
            keepAnimating = false;
        }

        public static SwingCharactersEffect Instance
        {
            get
            {
                return instance;
