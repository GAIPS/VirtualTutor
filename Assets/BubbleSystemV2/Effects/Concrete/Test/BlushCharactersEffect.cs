...
namespace BubbleSystem2
{
    ...
    {
        private static readonly BlushCharactersEffect instance = new BlushCharactersEffect();

        private BlushCharactersEffect() { }

        public static BlushCharactersEffect Instance
        {
            get
            {
                return instance;
