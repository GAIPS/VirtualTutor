...
//
            ...
            Line l10 = new Line("Devias ter estudado mais...",
                                grumpy,
                                2.5f,
                                7.5f);
            Line l11 = new Line("Podemos sempre fazer um plano de estudo, o que achas?",
                                ...
                                8.0f,
                                13.0f);
            Line l56 = new Line("Talvez consigas subir a nota",
                                grumpy,
                                10.5f,
                                15.5f);
...
//			grumpy.CurrentEmotion = Agent.EmotionType.POKERFACE;
            ...
            //More help?
//			//No need to change?
            Line l34 = new Line("Podemos ajudar-te em mais alguma coisa?",
                        happy,
                        0.0f,
                        5.0f);
            Line l35 = new Line("Agora já acertas o nós", grumpy, 2.5f, 7.5f);
            Topic.Input[] inputs8 =
            { new Topic.Input("queria falar de...", () => {
...
//		
//			// 2days with plan
            Line l36 = new Line("Daqui a dois dias vem cá para vermos como está a correr o plano",
                        happy,
                        0.0f,
                        5.0f);
            Line l37 = new Line("Espero que apareças", grumpy, 2.5f, 7.5f);
            Topic.Input[] inputs9 =
            { new Topic.Input("Até daqui a dois dias", () => {
...
//			//cedo
            Line l38 = new Line("Então quando queres entrar em contacto connosco?",
                        happy,
                        0.0f,
                        5.0f);
...
//
            Line l40 = new Line("Ok, até daqui a dois dias. Adeeeus!",
                        happy,
                        0.0f,
                        5.0f);
            Line l41 = new Line("Vou desligar para poupar o teu tempo e o nosso.",
                        grumpy,
                        2.5f,
                        7.5f);
...
//			//Nao sabe
            Line l44 = new Line("Pelos vistos ele não sabe, é normal nem toda a gente tem as coisas tão bem definidas como nós programas.",
                        grumpy,
                        0.0f,
                        5.0f);
            Line l45 = new Line("Então vemo-nos na próxima vez que vieres.",
                        happy,
                        2.5f,
                        7.5f);
            ...
            Line l46 = new Line("Bom, eu acho que ele não quer falar connosco.",
                        grumpy,
                        0.0f,
                        5.0f);
            Line l47 = new Line("De certeza que se fartou da tua atitude.",
                        happy,
                        2.5f,
                        7.5f);
            Line l48 = new Line("Sim, porque toda a gente adora a tua personalidade.",
                        grumpy,
                        8.0f,
                        13.0f);
            Line l49 = new Line("Mas e agora, o que fazemos?", happy, 10.5f, 15.5f);
            Line l50 = new Line("Epá desliga isso, já que estás tão contente e vamos embora.",
                        grumpy,
                        16.0f,
                        21.0f);
            ...
            //not answering test
            Line l52 = new Line("Bom, não queres falar sobre isso, ok.",
                        happy,
                        0.0f,
                        5.0f);
            Line l53 = new Line("Acho que um plano de estudo era uma boa ideia.",
                        grumpy,
                        2.5f,
                        7.5f);
            ...
            Line l54 = new Line("Ok parece que ele quer insistir neste plano.",
                        grumpy,
                        0.0f,
                        5.0f);
