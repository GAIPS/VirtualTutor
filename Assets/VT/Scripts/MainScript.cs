	...
	public class MainScript : MonoBehaviour
	{
		...
		void PopulateScene (Scene demoScene)
		{
			...
			grumpy.CurrentEmotion = Agent.EmotionType.POKERFACE;
			 Evaluation test1 = new Evaluation ("First Test", "20/03/2017", 4, 4, "12.0");
			 Evaluation project1 = new Evaluation ("First Project", "04/04/2017", 3, 4, "16.0");
			 CheckBoxPoint revision = new CheckBoxPoint ("PDF Class nº 20", "08/04/2017", 1, 3, true);
			Evaluation test2 = new Evaluation ("Second Test", "07/05/2017", 4, 4, "");
			Evaluation test3 = new Evaluation ("Third Test", "22/06/2017", 4, 4, "");
			...
			Evaluation c2Test1 = new Evaluation ("First Test","13/03/2017",3, 4, "14.0");
			Evaluation c2Test2 = new Evaluation ("Second Test", "15/04/2017", 3, 4, "12.0");
			CheckBoxPoint achievment = new CheckBoxPoint ("Extra Hours", "08/05/2017", 1, 3, false);
			Evaluation c2Teste3 = new Evaluation ("Third Test", "09/05/2017", 3, 4, "");
			Evaluation c2Test4 = new Evaluation ("Fourth Test", "2/06/2017", 3, 4, "");
			...
			Line l1 = new Line ("Hello. It is good to see you after these 2 days.", happy, 0.0f, 8.0f);
...
//
			...
			Line l10 = new Line ("You should have studied more...", grumpy, 4.0f, 12.0f);
			Line l11 = new Line ("Can we make a study plan to help you?",
				           happy,
				           12.5f,
				           20.5f);
			Line l56 = new Line ("Maybe it can help you improve.", grumpy, 16.5f, 24.5f);

			Topic.Input[] inputs3 = { new Topic.Input ("Study Plan? Ok", () => {
					grumpy.CurrentEmotion = Agent.EmotionType.IMPATIENT;
					happy.CurrentEmotion = Agent.EmotionType.SUBMISSIVE;
					demoScene.changeTopic ("onActivity");
...
//			grumpy.CurrentEmotion = Agent.EmotionType.SAD;
			...
			Line l12 = new Line ("You should have studied harder", grumpy, 0.0f, 8.0f);
...
//			
			...
			Line l17 = new Line ("Congratulations on a good grade.", happy, 0.0f, 8.0f);
			Line l18 = new Line ("There is still room for improvement.",
				           grumpy,
				           4.0f,
				           12.0f);
			Line l19 = new Line ("Don't rain on their parade", happy, 12.5f, 20.5f);
...
//			grumpy.CurrentEmotion = Agent.EmotionType.LIKES;
			//Colocar quando der
			Line l22 = new Line ("Congratulations on an awesome grade!", happy, 0.0f, 8.0f);
...
//			grumpy.CurrentEmotion = Agent.EmotionType.POKERFACE;
            ...
            //More help?
//			//No need to change?
			Line l34 = new Line ("Can we help a little more?", happy, 0.0f, 8.0f);
			Line l35 = new Line ("So it is \" us\" now? ", grumpy, 4.0f, 12.0f);
			Topic.Input[] inputs8 = { new Topic.Input ("I would like to talk about...", () => {
				happy.CurrentEmotion = Agent.EmotionType.SMILING;
				grumpy.CurrentEmotion = Agent.EmotionType.POKERFACE;
				demoScene.changeTopic ("talkAbout");	
				...
				},3.0f), new Topic.Input ("I have new information", () => {
					happy.CurrentEmotion = Agent.EmotionType.SMILING;
					grumpy.CurrentEmotion = Agent.EmotionType.POKERFACE;
					demoScene.changeTopic ("newInfoTopic");
				},4.5f)
...
//		
//			// 2days with plan
			Line l36 = new Line ("Come see us in two days so we can check up on your plan", happy, 0.0f, 8.0f);
			Line l37 = new Line ("I hope you show up", grumpy, 4.0f, 12.0f);
			Topic.Input[] inputs9 = { new Topic.Input ("See you in 2 days", () => {
				...
				},3.0f), new Topic.Input ("That is too soon", () => {
					happy.CurrentEmotion = Agent.EmotionType.SHY;
...
//			//cedo
			Line l38 = new Line ("When do you want to meet with us?", happy, 0.0f, 8.0f);
			Line l39 = new Line ("Maybe they don't want to see you", grumpy, 4.0f, 12.0f);
			Topic.Input[] inputs10 = { new Topic.Input (" 5 days", () => {
					happy.CurrentEmotion = Agent.EmotionType.DOMINANT;
					grumpy.CurrentEmotion = Agent.EmotionType.DOMINANT;
...
//
			...
			Line l41 = new Line ("I will switch this off to save all of us time.", grumpy, 4.0f, 12.0f);
...
//			//Nao sabe
			Line l44 = new Line ("Apparently he does not know, it is normal, not everyone is a machine like us.", grumpy, 0.0f, 8.0f);
			Line l45 = new Line ("See you when you next show up", happy, 4.0f, 12.0f);
			...
			Line l46 = new Line ("Well perhaps they don't want to talk.", grumpy, 0.0f, 8.0f);
			Line l47 = new Line ("Surely your attitude's fault.", happy, 4.0f, 12.0f);
			Line l48 = new Line ("Yes because you have a great personality.", grumpy, 12.5f, 20.5f);
			Line l49 = new Line ("Now what then?", happy, 16.5f, 24.5f);
			Line l50 = new Line ("Just turn it off since you're so chipper, let us go", grumpy, 25.0f, 33.0f);
			...
			Line l54 = new Line ("Ok they wants to insist in this bad plan", grumpy, 0.0f, 8.0f);
			...
			Line l59 = new Line ("A new information, what will it be? a test?.",happy,0.0f,8.0f);
			Line l60 = new Line ("I hope everything went well", grumpy,4.0f,12.0f);
			...
			Line l61 = new Line ("Anything you need, do not lean on my partner",grumpy,4.0f,12.0f);
			...
			Line l62 = new Line ("We know you have a checkpoint in 10 days",happy,0.0f,8.0f);
			...
			Line l66 = new Line("What would you like to talk about?", happy,0.0f,8.0f);
			Line l67 = new Line ("Please no personal things, we are study agents",grumpy,4.0f,12.0f);
			List<Line> talkAboutList = new List<Line>();
			talkAboutList.Add(l66);
			talkAboutList.Add(l67);
			Topic.Input[] talkInputs={ new Topic.Input("Past evaluations",()=>{
				happy.CurrentEmotion = Agent.EmotionType.SMILING;
				grumpy.CurrentEmotion = Agent.EmotionType.POKERFACE;
			...
			Line l70 = new Line("On FP we know we had a 12 on your test and 16 on a project. ",happy,0.0f,8.0f);
			Line l71 = new Line("And on AL you got a 14 on the first test and a 12 on the second one ",grumpy,4.0f,12.0f);
			...
			Topic.Input [] pastInputs={
				new Topic.Input("Thank you",()=>{
					...
					grumpy.CurrentEmotion = Agent.EmotionType.POKERFACE;
					demoScene.changeTopic("returnTopic");
				},1.5f), new Topic.Input("",()=>{}), new Topic.Input("More...",()=>{
				demoScene.OpenList();
				})
			};
			...
			Line l76 = new Line ("Make a study plan and keep it",happy,0.0f,8.0f);
			...
			Line l78 = new Line("If you give up we will drop this course to help you on others",happy,0.0f,8.0f);
			Line l79 = new Line("There is no shame in managing your time properly",grumpy,4.0f,12.0f);
			Line l80 = new Line("Is this what you want?",happy,12.5f,20.5f);
			List<Line> quitList = new List<Line>();
			quitList.Add(l78);
			quitList.Add(l79);
			quitList.Add(l80);
			Topic.Input[] quitInputs = { new Topic.Input("Yes please", ()=>{
				demoScene.changeTopic("help");
			}), new Topic.Input("",()=>{}),new Topic.Input("Maybe not",()=>{
				demoScene.OpenList();
			})};
			...
			Line l85 = new Line("This course is too important for that",grumpy,4.0f,12.0f);
			Line l86 = new Line("We hope we can help you or call your tutor",happy,12.5f,20.5f);
