...
public class PreviewBuildProcess : MonoBehaviour
{
    ...
    public static void BuildGame()
    {
        ...
        BuildGameForPlatform(previewLevels, path, BuildTarget.StandaloneWindows64);
        BuildGameForPlatform(previewLevels, path, BuildTarget.StandaloneLinux64);
        BuildGameForPlatform(previewLevels, path, BuildTarget.StandaloneOSXIntel64);
    ...
    private static void BuildGameForPlatform(string[] levels, string path, BuildTarget target)
    {
        ...
        // Build player.
        BuildPipeline.BuildPlayer(levels, buildPath + "Preview." + extention, target, BuildOptions.None);
